...
import { StopIcon, ResetIcon, StreamIcon, RecordIcon, DownloadIcon } from './icons';
            ...
            {status === AppStatus.Idle && (
                <>
                    <button
                        ...
                        className="flex items-center justify-center gap-2 px-5 py-2.5 font-semibold bg-red-600 text-white rounded-lg shadow-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition-all duration-200"
                    >
                        <RecordIcon />
                        Start Recording
                    </button>
